...
namespace PvZLikeDemo
{
    ...
    public sealed class GameForm : Form
    {
        ...
        private const float WaveCooldownDuration = 3.5f;
        ...
        private void OnKeyDown(object? sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.D2) _selectedPlant = PlantType.FortifiedSunflower;
        ...
        private void Step(float dt)
        {
            ...
            if ((int)(_time / 25f) > _wave)
            {
                ...
                _waveCooldownTimer = WaveCooldownDuration;
            }
            ...
            for (int r = 0; r < Rows; r++)
            {
                for (int c = 0; c < Cols; c++)
                {
                    ...
                    switch (cell.Type)
                    {
                        ...
                        case PlantType.FortifiedSunflower:
                            // generate sun periodically
                            if (cell.AuxTimer <= 0f)
                            {
                                cell.AuxTimer = 6.0f;
        ...
        private static int GetPlantCost(PlantType t) => t switch
        {
            ...
            PlantType.Bomb => 125,
            PlantType.FortifiedSunflower =>25,
            _ => 0
        };
        ...
        private void SpawnZombies(float dt)
        {
            ...
            _waveCooldownTimer -= dt;
            if (_waveCooldownTimer > 0f) return;
                ...
                for (int c = 0; c < Cols; c++)
                {
                    ...
                    switch (cell.Type)
                    {
                        ...
                        case PlantType.FortifiedSunflower:
                            DrawCircle(g, cx, cy, 22, Color.FromArgb(245, 205, 70));
                            DrawCircle(g, cx, cy, 10, Color.FromArgb(150, 90, 30));
                            DrawCircle(g, cx - 5, cy, 20, Color.FromArgb(245, 205, 70));
                            DrawCircle(g, cx + 16, cy - 2, 8, Color.FromArgb(150, 90, 30));
                            break;
        ...
        private void DrawUI(Graphics g)
        {
            ...
            DrawPlantButton(g, panelX, panelY + 170, PlantType.FortifiedSunflower, "5", GetPlantCost(PlantType.FortifiedSunflower));
